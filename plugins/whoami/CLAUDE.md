...
- **Ask only what the material cannot show.** Scope, sources, what each repository is, and identity are questions, because nothing in the history answers them. Nothing after that is.
